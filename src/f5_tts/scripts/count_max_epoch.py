...
"""
Adaptive batch size: using grouping batch sampler, frames_per_gpu fixed fed in
-> least padding, gather wavs with accumulated frames in a batch

epochs should be set to: 101 (100.8 x gd_acum 1)
progress_bar should show approx. 0/9919 updates
total 10580 hours
mini-batch of 307200 frames, 1.07 hours per mini-batch
"""