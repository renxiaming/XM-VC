...
import sys
# sys.path.append("/home/node57_data/hkxie/4O/F5-TTS/src/f5_tts/model")
from f5_tts.model.arch import AttentionBlock
...
if __name__ == '__main__':
    ...
    model = ECAPA_TDNN(in_channels=80, channels=512, embd_dim=128)
    out = model(x)
    print(model)
