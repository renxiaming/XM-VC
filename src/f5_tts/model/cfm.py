...
def hifigan_convert_wav(wav_data):
    ...
    def sample_streaming(
        ...
        *,
        ...
        for dur in duration:
            ...
            y0_full.append(torch.randn(int(dur), self.num_channels, device=self.device, dtype=torch.float32))
        ...
        while True:
            ...
            local_current_left = (current_frame_left - frame_left)*4
            local_current_right = (current_frame_right - frame_left)*4
            ...
            window_wav = vocoder(sampled_window.permute(0, 2, 1).float())
