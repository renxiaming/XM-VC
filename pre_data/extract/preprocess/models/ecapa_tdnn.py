    ...
    def __init__(self, feat_dim=80, channels=512, emb_dim=192, global_context_att=False,
        ...
        if feat_type == 'fbank':
            ...
            if config_path is None:
                # self.feature_extract = torch.hub.load('/home/work_nfs14/dkguo/seed-tts-eval-main/s3prl', feat_type, _verbose=True,source='local')
                ...
                # checkpoint = torch.load('/home/work_nfs14/dkguo/seed-tts-eval-main/UniSpeech/ckpt/wavlm_large.pt')
                # cfg = WavLMConfig(checkpoint["cfg"])
                # self.feature_extract = WavLM(cfg)
                # self.feature_extract.load_state_dict(checkpoint["model"])
                self.feature_extract = UpstreamExpert(ckpt='/home/node44_tmpdata2/code/preprocess/ckpts/wavlm_large.pt')
            else:
